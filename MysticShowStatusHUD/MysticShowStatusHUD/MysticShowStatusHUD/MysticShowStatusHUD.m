...
@implementation MysticShowStatusHUD
...
{
    [self showImageName:@"MysticShowStatusHUD.bundle/success" text:text];
}

+ (void)showError:(NSString *)text
{
    [self showImageName:@"MysticShowStatusHUD.bundle/error" text:text];
}
